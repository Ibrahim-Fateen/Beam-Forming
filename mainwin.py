...
"}")
        ...
        self.beamControlGroup = QtWidgets.QGroupBox(self.arrayManagerContents)
        ...
        self.verticalLayout.addWidget(self.beamControlGroup)
        ...
        MainWindow.addDockWidget(QtCore.Qt.DockWidgetArea(1), self.scenarioManagerDock)
